...
class BertModel(nn.Module):
    ...
    def forward(self, input_ids, speaker_ids, token_type_ids=None, attention_mask=None, trigger_pos=None):
        ...
        all_encoder_layers = self.encoder(embedding_output, extended_attention_mask, trigger_pos=trigger_pos)
...
class HiDialog_BERT(nn.Module):
    def __init__(self, 
        ...
        super(HiDialog_BERT, self).__init__()
    ...
    def forward(
        ...
        sequence_outputs, pooled_outputs = self.bert(input_ids, speaker_ids, token_type_ids, hidialog_mask, trigger_pos=trigger_pos) 
